...
<html>
  <head>
    ...
    <title>Welcome Payment System</title>
    ...
    <!-- Theme style -->
    <link href="stylesheets/dist/AdminLTE.css" rel="stylesheet" />
    <link href="stylesheets/dist/skins/_all-skins.min.css" rel="stylesheet" />
    <link href="stylesheets/supershopui.common.min.css" rel="stylesheet" />
    <style type="text/css">
        html {
            overflow: hidden;
        }
...
<body class="hold-transition skin-blue sidebar-mini fixed">
                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <!-- User Image -->
                                                    <img src="image/photos/girl2.png" class="img-circle" alt="User Image">
                                                </div>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="image/photos/girl2.png" class="user-image" alt="User Image">
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="image/photos/girl2.png" class="img-circle" alt="用户头像">
                    </div>
    ...
    <script src="javascripts/supershopui.common.js"></script>
